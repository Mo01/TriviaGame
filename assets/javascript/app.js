...
var imgAnsw = ["assets/images/Chilli.gif", "assets/images/Pia-Bread.gif", "assets/images/Baguette.gif", "assets/images/pizza.gif",
...
function displayQuestion(i) {
    ...
    if (i >= myQuestions.length) {
        ...
        $("#timer").text("Remaining Time = " + remainingTime + " Sec");
        ...
        var timeOut = setTimeout(function () {
            ...
            $("#answer").html("<img id='theImg' src=" + imgAnsw[i] + ">");
            $("#answer").append("<span>You are out of time!!!!!!!!!! It is " + myQuestions[i].correctAnswer +"</span>");
            setTimeout(function () {
                displayQuestion(i + 1);
            }, 3000);
        }, 15000);
        ...
        $("#answA").off('click').on('click', function () {
            if ($(this).val() === myQuestions[i].correctAnswer) {
                ...
                $('#answer').css('display', 'block');
                $("#answer").html("<img id='theImg' src=" + imgAnsw[i] + ">");
                $("#answer").append("<span>You are right!!!!!!!!!!</span>");
                setTimeout(function () {
                    displayQuestion(++i);
                    ;
                }, 4000);
                ...
                $('#answer').css('display', 'block');
                $("#answer").html("<img id='theImg' src=" + imgAnsw[i] + ">");
                $("#answer").append("<span>You are Wrong! It is " + myQuestions[i].correctAnswer + "</span>");
                setTimeout(function () {
                    displayQuestion(++i);
                }, 4000);
                clearTimeout(timeOut);
...
// start
$("#start1").off('click').on('click', function () {
...
/// Start over
$("#startO").off('click').on('click', function () {
    $('#start').css('display', 'none');
    $('#onGoing').css('display', 'block')
    var i = 0;
    displayQuestion(i);
